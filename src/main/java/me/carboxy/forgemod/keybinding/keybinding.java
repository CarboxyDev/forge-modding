...
public class keybinding {
    ...
    public static final KeyMapping KEYBINDING_SHOUT_KEY = new KeyMapping(KEYBINDING_SHOUT, KeyConflictContext.IN_GAME, InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_G, KEYBINDING_CATEGORY);
